"""Within-participant matching on motion or other continuous covariates."""
...
def match_within_subject(
    ...
    *,
    ...
    left_ids = _validated_subjects(left_subjects, n_observations=len(left))
    right_ids = _validated_subjects(right_subjects, n_observations=len(right))
    ...
    try:
        ...
        raise ModuleNotFoundError(
            "within-subject matching requires the 'qc' extra: "
            "pip install 'dfc-kit[qc]'"
        ) from error
